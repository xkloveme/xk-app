<!--
 * @Date: 2023-02-19
 * @LastEditTime: 2023-02-21 17:12:29
 * @LastEditors: xkloveme
 * @FileDesc:new page
 * @FilePath: /watone-cli/app/src/views/setting.vue
 * @Copyright © xkloveme
-->
<template>
 <div class='surface-0 text-center'>
    ...
    <div class='grid grid-cols-3 gap-4'>
      <AdvertiseBox header='PrimeVue 3.12' icon='pi-check-circle' color='green-600'>
      ...
      <AdvertiseBox header='UnoCSS' icon='pi-check-circle' color='green-600'>
        UnoCSS for
      </AdvertiseBox>
